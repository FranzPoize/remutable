...
describe('Remutable', function () {
  describe('just after creation', function () {
    it('should not be dirty', function () {
      return new _2.default().dirty.should.not.be.ok;
    });
    it('should have default hash', function () {
      return new _2.default().hash.should.be.exactly(-1549353149);
    });
  });

  describe('after setting two values', function () {
    describe('before committing the changes', function () {
      var userList = new _2.default().set('1', robert).set('2', isaac);
      it('should be dirty', function () {
        return userList.dirty.should.be.ok;
      });
      it('head should not be modified', function () {
        return (0, _should2.default)(userList.head.get('1')).be.exactly(void 0);
      });
      it('working should be modified', function () {
        return (0, _should2.default)(userList.working.get('1')).be.exactly(robert);
      });
    });
    ...
    describe('after committing the changes', function () {
      ...
      it('head should be modified', function () {
        (0, _should2.default)(userList.head.get('1')).be.exactly(robert);
        (0, _should2.default)(userList.head.get('2')).be.exactly(isaac);
      });
    });
  });
  describe('after uncommmitted changes', function () {
    ...
    userList.set('3', dan);
    it('working should be modified', function () {
      return (0, _should2.default)(userList.working.get('3')).be.exactly(dan);
    });
  });
  ...
  describe('after rollback', function () {
    ...
    it('working should be restored', function () {
      return (0, _should2.default)(userList.working.get('3')).be.exactly(void 0);
    });
  });
  ...
  describe('toJSON() into fromJSON()', function () {
    ...
    var userListCopy = _2.default.fromJSON(json);
...
describe('Patch', function () {
  ...
  var userListCopy = _2.default.fromJSON(userList.toJSON());
  ...
  describe('toJSON()', function () {
    return it('should output the correct JSON string', function () {
      return (0, _should2.default)(jsonPatch).be.exactly(JSON.stringify({
        m: {
          '3': {
            t: 'Dan Simmons'
          }
  ...
  describe('after transmission in JSON form', function () {
    ...
    it('should correctly update a local copy', function () {
      (0, _should2.default)(userListCopy.head.get('3')).be.exactly(dan);
    });
  });
});
...
describe('Patch revert, combine, Consumer, Producer', function () {
  ...
  it('should not throw', function () {
    ...
    var userListCopy2 = _2.default.fromJSON(userList.toJSON());
    userList.set('4', bard);
